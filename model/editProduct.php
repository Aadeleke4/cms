    ...
    if(isset($_GET['id'])){
        ...
        if($buy >= $sell){
            if(isset($_POST['Submit'])){
                $sql = "UPDATE products SET name='$pName', bought='$buy', sold='$sell', category_id='$category_id' WHERE id='$id'";
                    ...
                    <div class="col-sm-12" style="background-color: white; border: solid rgb(0, 162, 255);">
                        ...
                        <div class="row p-20" >
                            ...
                            <form method="POST" action="editProduct.php" class="row">
                                ...
                                <div class="row col-sm-6">
                                    <h4 class="pull-left col-sm-6">Category:</h4>
                                    <div class="col-sm-6">
                                        <select name="category" class="login-input" required>
                                            <?php
                                                while ($categoryRow = mysqli_fetch_assoc($categoryRes)) {
                                                    $selected = ($categoryRow['category_id'] == $res['category_id']) ? 'selected' : '';
